      ...
      <tr><td class="td-estilo"> 
         <section class="tabla">
            <table id="background-image" summary="Meeting Results">
               ...
               <tfoot>
                  <tr class="borde-fila">
                     <th colspan="7" > {{$Dpacientes -> links()}}</th>
                  </tr>
               </tfoot>
               ...
               <?php $contar=0; ?>
                  @foreach($Dpacientes as $Dpaciente)
                     <tr class="borde-fila">
                        <td><labe style="margin-left:20px;">{{$Dpaciente -> ID}}</labe></td>
                        <td>Activo</td>
                        <td> <?php echo HTML::link('/Pacientes/detalle/'.$Dpaciente->ID,$Dpaciente ->NOMBRE) ?></td>
                        <td><?php echo edad($Dpaciente->NACIMIENTO, $Dpaciente->SEXO); ?></td>
                        <td>{{$Dpaciente -> DESCRIPCION}}</td>
                        <td>{{$Dpaciente -> NOMBRE_TUTO}}</td>
